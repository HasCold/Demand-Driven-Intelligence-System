...
const ProductSummary = (props) => {
    ...
    const { brand, title, info, category, type, connectivity, description, reviews: productReviews } = props;
                    ...
                    <div className="prod_summary_details">
                        {
                            active === 'specs' ? (
                                ...
                                <div className="prod_reviews">
                                    <ul>
                                        {
                                            (productReviews && productReviews.length > 0 ? productReviews : reviewsData).map(item => (
                                                <ProductReviews
                                                    key={item.id}
                                                    {...item}
                                                />
