const filtersReducer = (state, action) => {
    switch (action.type) {
        ...
        case 'LOAD_ALL_PRODUCTS':
            ...
            const { products, minPrice, maxPrice, brandsMenu, categoryMenu } = action.payload;

            return {
                ...state,
                allProducts: products,
                updatedBrandsMenu: brandsMenu != null ? brandsMenu : state.updatedBrandsMenu,
                updatedCategoryMenu: categoryMenu != null ? categoryMenu : state.updatedCategoryMenu,
                selectedPrice: {
                    ...state.selectedPrice,
                    price: maxPrice,
                    minPrice: minPrice,
